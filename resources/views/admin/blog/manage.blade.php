...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Manage Lawas</h4>
                <a href="{{route('blog.add')}}" class="btn btn-success btn-sm">Tambah Lawas</a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('blog.delete', ['id'=> $blog->id]) }}" class="btn btn-danger btn-sm {{$blog->id== 1? 'disabled' : ''}}">
